        ...
        <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
          <div className="grid grid-cols-1 md:grid-cols-3 content-center">
            <div className="text-center sm:text-left pr-4">
              <div className="flex justify-center text-rose-600 sm:justify-start"></div>
              <NavLink to="/">
                <img src="/src/assets/logo.svg" alt="logo" className="h-12 " />
              </NavLink>
              <p className="mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left">
                Your one-stop destination for discovering and sharing amazing
                recipes. Cook, share, and enjoy!
              </p>
